...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-8 col-xs-offset-2 box">
                    <h1><fmt:message key="label.form.update" /></h1>
                    <form:form action="AddComputer" method="POST"
						modelAttribute="ComputerFormUpdateDTO">
						<fieldset>
							<legend><fmt:message key="label.form.update" /></legend>
	...
	<script type="text/javascript" src ="resources/js/AddComputer.js"></script>
</html>