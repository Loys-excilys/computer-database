...
insert into users (username, password, authority_id) values ('admin', '$2y$12$oigIfnDndN9XNik1qo5MTum.sxWcbR4.d3DW72GIWJZ9lcmb1FSrC', 1);
insert into users (username, password, authority_id) values ('user', '$2y$12$IH9DDrtwwFCV1j2zoA1RjOcNofOoqdhiHSyNU0pV/g6dIAXCWrznu', 2);
